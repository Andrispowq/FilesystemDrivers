...
#define EXT2_OPTIONAL_FEATURE_PREALLOCTE_BLOCKS 0x1
#define EXT2_OPTIONAL_FEATURE_HAS_AFS_SERVER_INODES 0x2
#define EXT2_OPTIONAL_FEATURE_HAS_JOURNAL 0x4
#define EXT2_OPTIONAL_FEATURE_INODE_EXTENDED_ATTRIBUTES 0x8
#define EXT2_OPTIONAL_FEATURE_CAN_RESIZE_FS 0x10
#define EXT2_OPTIONAL_FEATURE_USE_HASH_INDEX 0x20

#define EXT2_REQUIRED_COMPRESSION 0x1
#define EXT2_REQUIRED_DIRECTORY_HAS_TYPE 0x2
#define EXT2_REQUIRED_REPLAY_JOURNAL 0x4
#define EXT2_REQUIRED_USES_JOURNAL_DEVICE 0x8

#define EXT2_FEATURE_SPARSE_SUPERBLOCKS 0x1
#define EXT2_FEATURE_64_BIT_SIZE 0x2
#define EXT2_FEATURE_DIRECTORY_CONTENTS_IN_B_TREE 0x4
...
namespace ext2
{
	...
	struct DirEntry
	{
		...
		uint32_t offsetInParentInode = 0;
